...
namespace Library
{
    public partial class frmMaintenanceBook : Form
    {
        ...
        private void LoadBookDetails()
        {
            ...
            string[] sqlStatements = new string[] { sqlBookById, DataAccess.SQLCleaner(sqlNav) };
        ...
        private void txt_Validating(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            else if (txt.Name == "txtISBN" || txt.Name == "txtPrice")
            {
                ...
                else if(txt.Name == "txtISBN")
                {
                    if(txt.Text.Length != 13 && txt.Text.Length != 10)
                    {
                        errMsg = $"{txtBoxName} must be 10 or 13 characters";
                        e.Cancel = true;
                    }
                }
            }
